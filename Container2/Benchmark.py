...
def prepare_exp(SSHHost, SSHPort, REMOTEROOT, optpt):
    ...
    f.write("ssh -F config benchmark \"nohup ls root/memcached -p 11211 -P memcached.pid > memcached.out 2> memcached.err &\"\n") # adjust this line to properly start memcached
